...
> Grafana mantiene acciones oficiales para GitHub Actions, entre ellas `grafana/setup-k6-action`, pensadas para instalar y ejecutar k6 en CI/CD de forma más simple que una instalación manual.
